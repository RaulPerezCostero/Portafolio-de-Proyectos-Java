...
import model.Persona4;

public class Ejercicio4 {
    public static void main(String[] args) throws Exception {
        
        Persona4[] personas = new Persona4[3]; // Crea lista de tres posiciones, las listas empiezan en el cero.
        for (int index = 0; index < personas.length; index++){
            personas[index] = new Persona4();
            ...
            String promptTalla = String.format("Ingrese el talla (m) de %s: ", personas[index].getNombre());
        ...
        Persona4 masAlta = personas[0];
        Persona4 masPesada = personas[0];
