...
import model.Persona3;

public class Ejercicio3 {
    public static void main(String[] args) throws Exception {
        
        Persona3[] personas = new Persona3[3]; // Crea lista de tres posiciones, las listas empiezan en el cero.
        for (int index = 0; index < personas.length; index++){
            personas[index] = new Persona3();
        ...
        Persona3 masAlta = personas[0];
        Persona3 masPesada = personas[0];
